...
export default function DialogImport({ groups }) {
        ...
        <>
            ...
            <Dialog open={open} onOpenChange={handleOpenChange}>
                <DialogContent className="sm:max-w-3xl max-h-[90vh] overflow-y-auto">
                    <DialogHeader>
                        <DialogTitle>Import Participant</DialogTitle>
                        <DialogDescription>
                            Import peserta secara massal menggunakan file excel.
                        </DialogDescription>
                    </DialogHeader>
